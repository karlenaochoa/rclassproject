...
# Cleaning our data: selecting what variables we need, getting rid of NAs, recoding condition age group and gender for an easier analysis, greating the "Average trust" variable that is an average of total trust per subject: 
