...
```{r summary table for plot 1, fig.cap='Average trust scores by age group and condition'}
...
``` {r plot 1, cache=FALSE, fig.cap='practice', fig.lp=" "}
# Constructing Plot 1 
